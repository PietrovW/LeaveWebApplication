...
namespace Leave.Infrastructure.Handlers
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<LeaveException, Task> _onCustomErrorAsync;
        private Func<LeaveException, Logger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Func<LeaveException, Task> onCustomError,
        ...
        public IHandlerTask OnCustomError(Func<LeaveException, Logger, Task> onCustomError,
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
            var customException = exception as LeaveException;
